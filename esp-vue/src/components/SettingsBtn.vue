<template>
  <div
    id="SettingsBtn"
    :title="title"
    class="form-check form-switch sticky-top"
    @click="handle"
  >
    <svg
      id="SettingsBtnGlyph"
      ...
      :class="{ 'text-success': !active, 'text-primary': active }"
      fill="currentColor"
    ...
    <button
      id="toggleSettingsModal"
      type="button"
      data-toggle="modal"
      data-target="#SettingsModalId"
      class="btn d-none w-0 h-0"
    ></button>
  </div>
</template>
